...
async function getXSMNData() {
    // Lấy tất cả đài XSMN mới nhất (có thể 2-3 đài/ngày)
    ...
    // Lịch sử 7 kỳ — lấy theo từng đài riêng (group by province)
    ...
    // Lấy ngày của draw mới nhất
    const latestDate = draws[0]?.drawDate ?? null

    // Lọc draws cùng ngày mới nhất
